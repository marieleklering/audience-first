...
AudienceFirst ships with four question sets, each tuned for a different content type
and feedback goal. Pass `--mode <name>` to select one.

## default

**Use when:** General technical documentation, how-to guides, runbooks.
...
**Use when:** Default feedback feels too comfortable. You want the persona to push harder.

1. Where did you stop reading, even briefly, and why?
2. What would you tell a colleague this document got wrong or oversimplified?
...
**Use when:** Portfolio pieces, case studies, work samples — content where individual
contribution and credibility are under scrutiny.
